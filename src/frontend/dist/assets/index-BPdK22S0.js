...
function Layout({ children }) {
  ...
  const [ttInput, setTtInput] = reactExports.useState("");
  const [ttType, setTtType] = reactExports.useState("movie");
  const ttRef = reactExports.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b sticky top-0 z-50 shadow-[0_2px_24px_rgba(0,0,0,0.8)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-3 flex flex-col sm:flex-row items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary flex items-center justify-center shadow-[0_0_16px_oklch(0.48_0.22_16/0.5)] group-hover:shadow-[0_0_24px_oklch(0.48_0.22_16/0.7)] transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Film, { className: "w-5 h-5 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:block", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-lg tracking-tight text-foreground leading-none", children: [
                "Stream",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Lookup" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground font-mono uppercase tracking-widest leading-none mt-0.5", children: "Your Streaming Hub" })
            ] })
          ]
        }
      ),
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "movie", children: "Movie" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "tv", children: "TV" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-4", children: [
...
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-12 space-y-6", children: SKELETON_3.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-full rounded-xl" }, k)) }),
...
const watchRoute = createRoute({
  ...
  validateSearch: (search) => ({
    ...
    poster: typeof search.poster === "string" ? search.poster : void 0,
    tmdbId: typeof search.tmdbId === "string" ? search.tmdbId : void 0
  }),
  component: WatchPage
});
